package com.voya.doctor.client;

import com.voya.doctor.model.Doctor;
import com.voya.doctor.model.Specialization;
import com.voya.doctor.service.DoctorServiceImpl;

import java.util.List;

public class Client {
    public static <IdNotFoundException, DoctorNotFoundException> void main(String[] args) {
